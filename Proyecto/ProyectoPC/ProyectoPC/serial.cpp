...
/*
Configura el puerto serie para comunicarse por el COM3, a 38400 baudios,  8 bits, no-stop, no-parity 
Si quieres cambiarlo es necesario tocar el código fuente*/
CSerial::CSerial()
{
	unsigned long dwError;
	LPCTSTR lpszPortName = TEXT("COM6"); //Indicas el nombre del puerto serie.
